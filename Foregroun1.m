clc; clear;
foregroundDetector = vision.ForegroundDetector('NumGaussians', 3,'NumTrainingFrames', 500);

videoReader = VideoReader('C:\Users\furoz\OneDrive\Masaüstü\project 2\carshortvideo.mp4');
for i = 1:150
...
se = strel('square', 12); % morphological filter for noise removal
